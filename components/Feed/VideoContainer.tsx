    ...
    >
      ...
      <AnimatePresence>
        {showHeartAnim && (
          ...
          >
            <Heart fill="#D4AF37" color="#D4AF37" size={120} className="drop-shadow-[0_0_20px_rgba(212,175,55,0.6)]" />
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <AnimatePresence>
        {showMuteFeedback && (
          ...
          >
            <div className="bg-black/40 backdrop-blur-md p-6 rounded-full text-white">
      ...
      <div className="absolute left-0 right-16 bottom-24 p-6 z-10 pointer-events-none">
        ...
        <p className="text-sm text-white drop-shadow-lg line-clamp-2 mb-4 leading-relaxed">
          {description}
        </p>
